...
If you enjoy Roblox Rewind, consider [supporting me on Ko-fi](https://ko-fi.com/cosisety).

Found a bug? [Open an issue](https://github.com/Cosisety/Roblox-Rewind/issues).
